...
package com.theatro.curbside.webSocket;
...
import com.theatro.curbside.webSocket.WebSocket.WebSocketConnectionObserver.WebSocketCloseNotification;
import com.theatro.curbside.webSocket.WebSocketMessage.WebSocketCloseCode;
...
public class WebSocketConnection implements WebSocket {
        ...
        mSocketThread.getHandler().post(new Runnable() {
            ...
            public void run() {
                ...
                mSocketThread.startConnection();
                    ...
                    onClose(WebSocketCloseNotification.CANNOT_CONNECT, e.getLocalizedMessage());
                }
            }
        });
    ...
    public static class SocketThread extends Thread {
        ...
        public void startConnection() throws IllegalArgumentException {
            try {
...
//                        port = 50080;
                        port = Integer.parseInt(MainActivity.logOnUrl.split(":")[1]);
                    }
                }
